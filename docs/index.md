...
![PayloadStash](assets/PayloadStash-Banner.png){ .hero }

PayloadStash sends HTTP and AMQP payloads from declarative YAML, captures values from responses, and verifies the results with reusable expectations.
